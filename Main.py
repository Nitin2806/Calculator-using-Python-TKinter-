...
button_plus = Button(gui, text='+', padx=40,pady=20, command=lambda: button_click(),bg='#000000', fg='#ffffff', activebackground='#595454', activeforeground='#5e5e56')
...
button_minus = Button(gui, text='-', padx=40,pady=20, command=lambda: button_click(),bg='#000000', fg='#ffffff', activebackground='#595454', activeforeground='#5e5e56')
...
button_multi = Button(gui, text='*', padx=40,pady=20, command=lambda: button_click(),bg='#000000', fg='#ffffff', activebackground='#595454', activeforeground='#5e5e56')

button_divi = Button(gui, text='/', padx=40,pady=20, command=lambda: button_click(),bg='#000000', fg='#ffffff', activebackground='#595454', activeforeground='#5e5e56')
...
button_equal = Button(gui, text='=', padx=40,pady=20, command=lambda: button_click(),bg='#000000', fg='#ffffff', activebackground='#595454', activeforeground='#5e5e56')
